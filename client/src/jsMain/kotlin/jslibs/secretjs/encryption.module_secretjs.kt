...
external interface EncryptionUtils {
    var getPubkey: () -> Promise<Uint8Array>
    var decrypt: (ciphertext: Uint8Array, nonce: Uint8Array) -> Promise<Uint8Array>
    var encrypt: (contractCodeHash: String, msg: Any?) -> Promise<Uint8Array>
    var getTxEncryptionKey: (nonce: Uint8Array) -> Promise<Uint8Array>
}
