...
@interface SecretkBase : NSObject
...
@protocol SecretkKotlinx_serialization_coreSerialFormat
@required
...
@protocol SecretkKotlinx_serialization_coreStringFormat <SecretkKotlinx_serialization_coreSerialFormat>
@required
- (id _Nullable)decodeFromStringDeserializer:(id<SecretkKotlinx_serialization_coreDeserializationStrategy>)deserializer string:(NSString *)string __attribute__((swift_name("decodeFromString(deserializer:string:)")));
- (NSString *)encodeToStringSerializer:(id<SecretkKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeToString(serializer:value:)")));
@end;

__attribute__((swift_name("Json")))
@interface SecretkJson : SecretkBase <SecretkKotlinx_serialization_coreStringFormat>
@property (class, readonly, getter=companion) SecretkJsonDefault *companion __attribute__((swift_name("companion")));
- (id _Nullable)decodeFromJsonElementDeserializer:(id<SecretkKotlinx_serialization_coreDeserializationStrategy>)deserializer element:(SecretkJsonElement *)element __attribute__((swift_name("decodeFromJsonElement(deserializer:element:)")));
- (id _Nullable)decodeFromStringDeserializer:(id<SecretkKotlinx_serialization_coreDeserializationStrategy>)deserializer string:(NSString *)string __attribute__((swift_name("decodeFromString(deserializer:string:)")));
- (SecretkJsonElement *)encodeToJsonElementSerializer:(id<SecretkKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeToJsonElement(serializer:value:)")));
- (NSString *)encodeToStringSerializer:(id<SecretkKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeToString(serializer:value:)")));
- (SecretkJsonElement *)parseToJsonElementString:(NSString *)string __attribute__((swift_name("parseToJsonElement(string:)")));
@property (readonly) SecretkJsonConfiguration *configuration __attribute__((swift_name("configuration")));
@property (readonly) SecretkKotlinx_serialization_coreSerializersModule *serializersModule __attribute__((swift_name("serializersModule")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Json.Default")))
@interface SecretkJsonDefault : SecretkJson
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)default_ __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkJsonDefault *shared __attribute__((swift_name("shared")));
@end;

__attribute__((unavailable("can't be imported")))
__attribute__((swift_name("JsonArray")))
@interface SecretkJsonArray : NSObject
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("JsonArrayBuilder")))
@interface SecretkJsonArrayBuilder : SecretkBase
- (BOOL)addElement:(SecretkJsonElement *)element __attribute__((swift_name("add(element:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("JsonBuilder")))
@interface SecretkJsonBuilder : SecretkBase
...
@property SecretkKotlinx_serialization_coreSerializersModule *serializersModule __attribute__((swift_name("serializersModule")));
...
@interface SecretkJsonConfiguration : SecretkBase
...
@interface SecretkJsonContentPolymorphicSerializer<T> : SecretkBase <SecretkKotlinx_serialization_coreKSerializer>
- (instancetype)initWithBaseClass:(id<SecretkKotlinKClass>)baseClass __attribute__((swift_name("init(baseClass:)"))) __attribute__((objc_designated_initializer));
- (T)deserializeDecoder:(id<SecretkKotlinx_serialization_coreDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (id<SecretkKotlinx_serialization_coreDeserializationStrategy>)selectDeserializerElement:(SecretkJsonElement *)element __attribute__((swift_name("selectDeserializer(element:)")));
- (void)serializeEncoder:(id<SecretkKotlinx_serialization_coreEncoder>)encoder value:(T)value __attribute__((swift_name("serialize(encoder:value:)")));
@property (readonly) id<SecretkKotlinx_serialization_coreSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
- (id<SecretkKotlinx_serialization_coreDecoder>)decodeInlineInlineDescriptor:(id<SecretkKotlinx_serialization_coreSerialDescriptor>)inlineDescriptor __attribute__((swift_name("decodeInline(inlineDescriptor:)")));
...
@protocol SecretkJsonDecoder <SecretkKotlinx_serialization_coreDecoder, SecretkKotlinx_serialization_coreCompositeDecoder>
@required
- (SecretkJsonElement *)decodeJsonElement __attribute__((swift_name("decodeJsonElement()")));
@property (readonly) SecretkJson *json __attribute__((swift_name("json")));
@end;

__attribute__((swift_name("JsonElement")))
@interface SecretkJsonElement : SecretkBase
@property (class, readonly, getter=companion) SecretkJsonElementCompanion *companion __attribute__((swift_name("companion")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("JsonElement.Companion")))
@interface SecretkJsonElementCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkJsonElementCompanion *shared __attribute__((swift_name("shared")));
...
- (id<SecretkKotlinx_serialization_coreEncoder>)encodeInlineInlineDescriptor:(id<SecretkKotlinx_serialization_coreSerialDescriptor>)inlineDescriptor __attribute__((swift_name("encodeInline(inlineDescriptor:)")));
...
@protocol SecretkJsonEncoder <SecretkKotlinx_serialization_coreEncoder, SecretkKotlinx_serialization_coreCompositeEncoder>
@required
- (void)encodeJsonElementElement:(SecretkJsonElement *)element __attribute__((swift_name("encodeJsonElement(element:)")));
@property (readonly) SecretkJson *json __attribute__((swift_name("json")));
@end;

__attribute__((swift_name("JsonPrimitive")))
@interface SecretkJsonPrimitive : SecretkJsonElement
@property (class, readonly, getter=companion) SecretkJsonPrimitiveCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SecretkJsonNull : SecretkJsonPrimitive
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)jsonNull __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkJsonNull *shared __attribute__((swift_name("shared")));
- (id<SecretkKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@interface SecretkJsonObject : NSObject
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("JsonObjectBuilder")))
@interface SecretkJsonObjectBuilder : SecretkBase
- (SecretkJsonElement * _Nullable)putKey:(NSString *)key element:(SecretkJsonElement *)element __attribute__((swift_name("put(key:element:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("JsonPrimitive.Companion")))
@interface SecretkJsonPrimitiveCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkJsonPrimitiveCompanion *shared __attribute__((swift_name("shared")));
- (id<SecretkKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((swift_name("JsonTransformingSerializer")))
@interface SecretkJsonTransformingSerializer<T> : SecretkBase <SecretkKotlinx_serialization_coreKSerializer>
- (instancetype)initWithTSerializer:(id<SecretkKotlinx_serialization_coreKSerializer>)tSerializer __attribute__((swift_name("init(tSerializer:)"))) __attribute__((objc_designated_initializer));
- (T)deserializeDecoder:(id<SecretkKotlinx_serialization_coreDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (void)serializeEncoder:(id<SecretkKotlinx_serialization_coreEncoder>)encoder value:(T)value __attribute__((swift_name("serialize(encoder:value:)")));
- (SecretkJsonElement *)transformDeserializeElement:(SecretkJsonElement *)element __attribute__((swift_name("transformDeserialize(element:)")));
- (SecretkJsonElement *)transformSerializeElement:(SecretkJsonElement *)element __attribute__((swift_name("transformSerialize(element:)")));
@property (readonly) id<SecretkKotlinx_serialization_coreSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
@property (class, readonly, getter=companion) SecretkKotlinEnumCompanion *companion __attribute__((swift_name("companion")));
...
@interface SecretkBroadcastMode : SecretkKotlinEnum<SecretkBroadcastMode *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SecretkBroadcastMode *block __attribute__((swift_name("block")));
@property (class, readonly) SecretkBroadcastMode *sync __attribute__((swift_name("sync")));
...
- (instancetype)initWithAddress:(NSString *)address pub_key:(SecretkSecp256k1PubKey *)pub_key account_number:(SecretkBignumBigInteger * _Nullable)account_number sequence:(SecretkBignumBigInteger * _Nullable)sequence __attribute__((swift_name("init(address:pub_key:account_number:sequence:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkAccountCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SecretkSecp256k1PubKey *)component2 __attribute__((swift_name("component2()")));
- (SecretkBignumBigInteger * _Nullable)component3 __attribute__((swift_name("component3()")));
- (SecretkBignumBigInteger * _Nullable)component4 __attribute__((swift_name("component4()")));
- (SecretkAccount *)doCopyAddress:(NSString *)address pub_key:(SecretkSecp256k1PubKey *)pub_key account_number:(SecretkBignumBigInteger * _Nullable)account_number sequence:(SecretkBignumBigInteger * _Nullable)sequence __attribute__((swift_name("doCopy(address:pub_key:account_number:sequence:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SecretkBignumBigInteger * _Nullable account_number __attribute__((swift_name("account_number")));
@property (readonly) NSString *address __attribute__((swift_name("address")));
@property (readonly) SecretkSecp256k1PubKey *pub_key __attribute__((swift_name("pub_key")));
...
@interface SecretkAccountCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (SecretkAccount *)component1 __attribute__((swift_name("component1()")));
...
@interface SecretkAccountResponseCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkApplicationVersionCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthAccountsResult")))
@interface SecretkAuthAccountsResult : SecretkTypeValue<SecretkCosmosSdkAccount *>
- (instancetype)initWithValue:(SecretkCosmosSdkAccount *)value __attribute__((swift_name("init(value:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkAuthAccountsResultCompanion *companion __attribute__((swift_name("companion")));
- (SecretkCosmosSdkAccount *)component1 __attribute__((swift_name("component1()")));
- (SecretkAuthAccountsResult *)doCopyValue:(SecretkCosmosSdkAccount *)value __attribute__((swift_name("doCopy(value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SecretkCosmosSdkAccount *value __attribute__((swift_name("value")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthAccountsResult.Companion")))
@interface SecretkAuthAccountsResultCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkAuthAccountsResultCompanion *shared __attribute__((swift_name("shared")));
- (id<SecretkKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;
...
- (NSArray<SecretkCoin *> *)component1 __attribute__((swift_name("component1()")));
...
@interface SecretkBalanceResponseCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CosmosSdkAccount")))
@interface SecretkCosmosSdkAccount : SecretkBase
- (instancetype)initWithAddress:(NSString * _Nullable)address coins:(NSArray<SecretkCoin *> * _Nullable)coins public_key:(SecretkPubKeySecp256k1 * _Nullable)public_key account_number:(SecretkBignumBigInteger * _Nullable)account_number sequence:(SecretkBignumBigInteger * _Nullable)sequence __attribute__((swift_name("init(address:coins:public_key:account_number:sequence:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkCosmosSdkAccountCompanion *companion __attribute__((swift_name("companion")));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSArray<SecretkCoin *> * _Nullable)component2 __attribute__((swift_name("component2()")));
- (SecretkPubKeySecp256k1 * _Nullable)component3 __attribute__((swift_name("component3()")));
- (SecretkBignumBigInteger * _Nullable)component4 __attribute__((swift_name("component4()")));
- (SecretkBignumBigInteger * _Nullable)component5 __attribute__((swift_name("component5()")));
- (SecretkCosmosSdkAccount *)doCopyAddress:(NSString * _Nullable)address coins:(NSArray<SecretkCoin *> * _Nullable)coins public_key:(SecretkPubKeySecp256k1 * _Nullable)public_key account_number:(SecretkBignumBigInteger * _Nullable)account_number sequence:(SecretkBignumBigInteger * _Nullable)sequence __attribute__((swift_name("doCopy(address:coins:public_key:account_number:sequence:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SecretkBignumBigInteger * _Nullable account_number __attribute__((swift_name("account_number")));
@property (readonly) NSString * _Nullable address __attribute__((swift_name("address")));
@property (readonly) NSArray<SecretkCoin *> * _Nullable coins __attribute__((swift_name("coins")));
@property (readonly) SecretkPubKeySecp256k1 * _Nullable public_key __attribute__((swift_name("public_key")));
@property (readonly) SecretkBignumBigInteger * _Nullable sequence __attribute__((swift_name("sequence")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CosmosSdkAccount.Companion")))
@interface SecretkCosmosSdkAccountCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkCosmosSdkAccountCompanion *shared __attribute__((swift_name("shared")));
- (id<SecretkKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;
...
- (SecretkProtocolVersion *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (NSString *)component5 __attribute__((swift_name("component5()")));
...
- (SecretkNodeInfoOther *)component8 __attribute__((swift_name("component8()")));
...
@interface SecretkNodeInfoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkNodeInfoOtherCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithNode_info:(SecretkNodeInfo *)node_info application_version:(SecretkApplicationVersion *)application_version __attribute__((swift_name("init(node_info:application_version:)"))) __attribute__((objc_designated_initializer));
...
@interface SecretkNodeInfoResponseCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkProtocolVersionCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkPubKeyCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkPubKeyEd25519Companion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkPubKeyMultisigThresholdCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkPubKeySecp256k1Companion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkPubKeySr25519Companion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkSecp256k1PubKeyCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@property (class, readonly, getter=companion) SecretkSmartQueryResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *data __attribute__((swift_name("data")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SmartQueryResponse.Companion")))
@interface SecretkSmartQueryResponseCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TxsResponse")))
@interface SecretkTxsResponse : SecretkBase
- (instancetype)initWithTx_response:(SecretkTxsResponseData *)tx_response __attribute__((swift_name("init(tx_response:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkTxsResponseCompanion *companion __attribute__((swift_name("companion")));
- (SecretkTxsResponseData *)component1 __attribute__((swift_name("component1()")));
- (SecretkTxsResponse *)doCopyTx_response:(SecretkTxsResponseData *)tx_response __attribute__((swift_name("doCopy(tx_response:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SecretkTxsResponseData *tx_response __attribute__((swift_name("tx_response")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TxsResponse.Companion")))
@interface SecretkTxsResponseCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkTxsResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SecretkKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TxsResponseData")))
@interface SecretkTxsResponseData : SecretkBase
- (instancetype)initWithHeight:(NSString *)height txhash:(NSString *)txhash code:(SecretkInt * _Nullable)code raw_log:(NSString * _Nullable)raw_log data:(NSString *)data logs:(NSArray<SecretkLog *> * _Nullable)logs gas_wanted:(NSString * _Nullable)gas_wanted gas_used:(NSString * _Nullable)gas_used __attribute__((swift_name("init(height:txhash:code:raw_log:data:logs:gas_wanted:gas_used:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkTxsResponseDataCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (SecretkInt * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (NSString *)component5 __attribute__((swift_name("component5()")));
- (NSArray<SecretkLog *> * _Nullable)component6 __attribute__((swift_name("component6()")));
- (NSString * _Nullable)component7 __attribute__((swift_name("component7()")));
- (NSString * _Nullable)component8 __attribute__((swift_name("component8()")));
- (SecretkTxsResponseData *)doCopyHeight:(NSString *)height txhash:(NSString *)txhash code:(SecretkInt * _Nullable)code raw_log:(NSString * _Nullable)raw_log data:(NSString *)data logs:(NSArray<SecretkLog *> * _Nullable)logs gas_wanted:(NSString * _Nullable)gas_wanted gas_used:(NSString * _Nullable)gas_used __attribute__((swift_name("doCopy(height:txhash:code:raw_log:data:logs:gas_wanted:gas_used:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString * _Nullable gas_used __attribute__((swift_name("gas_used")));
@property (readonly) NSString * _Nullable gas_wanted __attribute__((swift_name("gas_wanted")));
@property (readonly) NSString *height __attribute__((swift_name("height")));
@property (readonly) NSArray<SecretkLog *> * _Nullable logs __attribute__((swift_name("logs")));
@property (readonly) NSString * _Nullable raw_log __attribute__((swift_name("raw_log")));
@property (readonly) NSString *txhash __attribute__((swift_name("txhash")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TxsResponseData.Companion")))
@interface SecretkTxsResponseDataCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkTxsResponseDataCompanion *shared __attribute__((swift_name("shared")));
- (id<SecretkKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TypeValueCompanion")))
@interface SecretkTypeValueCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkV1BetaTypeCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (R _Nullable)component2 __attribute__((swift_name("component2()")));
...
@interface SecretkWasmResponseCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Account_")))
@interface SecretkAccount_ : SecretkBase
- (instancetype)initWithAddress:(NSString *)address balance:(NSArray<SecretkCoin *> *)balance pubkey:(SecretkPubKeySecp256k1 * _Nullable)pubkey accountNumber:(SecretkBignumBigInteger *)accountNumber sequence:(SecretkBignumBigInteger *)sequence __attribute__((swift_name("init(address:balance:pubkey:accountNumber:sequence:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSArray<SecretkCoin *> *)component2 __attribute__((swift_name("component2()")));
- (SecretkPubKeySecp256k1 * _Nullable)component3 __attribute__((swift_name("component3()")));
- (SecretkBignumBigInteger *)component4 __attribute__((swift_name("component4()")));
- (SecretkBignumBigInteger *)component5 __attribute__((swift_name("component5()")));
- (SecretkAccount_ *)doCopyAddress:(NSString *)address balance:(NSArray<SecretkCoin *> *)balance pubkey:(SecretkPubKeySecp256k1 * _Nullable)pubkey accountNumber:(SecretkBignumBigInteger *)accountNumber sequence:(SecretkBignumBigInteger *)sequence __attribute__((swift_name("doCopy(address:balance:pubkey:accountNumber:sequence:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SecretkBignumBigInteger *accountNumber __attribute__((swift_name("accountNumber")));
@property (readonly) NSString *address __attribute__((swift_name("address")));
@property (readonly) NSArray<SecretkCoin *> *balance __attribute__((swift_name("balance")));
@property (readonly) SecretkPubKeySecp256k1 * _Nullable pubkey __attribute__((swift_name("pubkey")));
...
@interface SecretkCoinCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeeTable")))
@interface SecretkFeeTable : SecretkBase
- (instancetype)initWithUpload:(SecretkStdFee * _Nullable)upload init:(SecretkStdFee * _Nullable)init exec:(SecretkStdFee * _Nullable)exec send:(SecretkStdFee * _Nullable)send __attribute__((swift_name("init(upload:init:exec:send:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkFeeTableCompanion *companion __attribute__((swift_name("companion")));
- (SecretkStdFee * _Nullable)component1 __attribute__((swift_name("component1()")));
- (SecretkStdFee * _Nullable)component2 __attribute__((swift_name("component2()")));
- (SecretkStdFee * _Nullable)component3 __attribute__((swift_name("component3()")));
- (SecretkStdFee * _Nullable)component4 __attribute__((swift_name("component4()")));
- (SecretkFeeTable *)doCopyUpload:(SecretkStdFee * _Nullable)upload init:(SecretkStdFee * _Nullable)init exec:(SecretkStdFee * _Nullable)exec send:(SecretkStdFee * _Nullable)send __attribute__((swift_name("doCopy(upload:init:exec:send:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (SecretkFeeTable *)overwriteNewTable:(SecretkFeeTable * _Nullable)newTable __attribute__((swift_name("overwrite(newTable:)")));
- (NSString *)description __attribute__((swift_name("description()")));
@property SecretkStdFee * _Nullable exec __attribute__((swift_name("exec")));
@property (getter=doInit) SecretkStdFee * _Nullable init __attribute__((swift_name("init")));
@property SecretkStdFee * _Nullable send __attribute__((swift_name("send")));
@property SecretkStdFee * _Nullable upload __attribute__((swift_name("upload")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeeTable.Companion")))
@interface SecretkFeeTableCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkFeeTableCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) SecretkFeeTable *Default __attribute__((swift_name("Default")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PostTxResult")))
@interface SecretkPostTxResult : SecretkBase
- (instancetype)initWithLogs:(NSArray<SecretkLog *> *)logs rawLog:(NSString *)rawLog data:(NSString *)data transactionHash:(NSString *)transactionHash __attribute__((swift_name("init(logs:rawLog:data:transactionHash:)"))) __attribute__((objc_designated_initializer));
- (NSArray<SecretkLog *> *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (SecretkPostTxResult *)doCopyLogs:(NSArray<SecretkLog *> *)logs rawLog:(NSString *)rawLog data:(NSString *)data transactionHash:(NSString *)transactionHash __attribute__((swift_name("doCopy(logs:rawLog:data:transactionHash:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *data __attribute__((swift_name("data")));
@property (readonly) NSArray<SecretkLog *> *logs __attribute__((swift_name("logs")));
@property (readonly) NSString *rawLog __attribute__((swift_name("rawLog")));
...
- (SecretkAnyProto *)component1 __attribute__((swift_name("component1()")));
- (SecretkBignumBigInteger *)component2 __attribute__((swift_name("component2()")));
...
- (instancetype)initWithAmount:(NSArray<SecretkCoin *> *)amount gas:(int32_t)gas __attribute__((swift_name("init(amount:gas:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkStdFeeCompanion *companion __attribute__((swift_name("companion")));
- (NSArray<SecretkCoin *> *)component1 __attribute__((swift_name("component1()")));
- (int32_t)component2 __attribute__((swift_name("component2()")));
- (SecretkStdFee *)doCopyAmount:(NSArray<SecretkCoin *> *)amount gas:(int32_t)gas __attribute__((swift_name("doCopy(amount:gas:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SecretkCoin *> *amount __attribute__((swift_name("amount")));
@property (readonly) int32_t gas __attribute__((swift_name("gas")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StdFee.Companion")))
@interface SecretkStdFeeCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithPub_key:(SecretkPubKeySecp256k1 *)pub_key signature:(NSString *)signature __attribute__((swift_name("init(pub_key:signature:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkStdSignatureCompanion *companion __attribute__((swift_name("companion")));
- (SecretkPubKeySecp256k1 *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (SecretkStdSignature *)doCopyPub_key:(SecretkPubKeySecp256k1 *)pub_key signature:(NSString *)signature __attribute__((swift_name("doCopy(pub_key:signature:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SecretkPubKeySecp256k1 *pub_key __attribute__((swift_name("pub_key")));
@property (readonly) NSString *signature __attribute__((swift_name("signature")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StdSignature.Companion")))
@interface SecretkStdSignatureCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (NSArray<SecretkTypeValue<T> *> *)component1 __attribute__((swift_name("component1()")));
- (SecretkStdFee *)component2 __attribute__((swift_name("component2()")));
- (NSArray<SecretkStdSignature *> *)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
...
@interface SecretkStdTxCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SecretkTxBodyValue<M> *)component2 __attribute__((swift_name("component2()")));
...
@interface SecretkTxBodyCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (NSArray<SecretkProtoMsg<M> *> *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
...
@interface SecretkTxBodyValueCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkAddress : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)encryptContractCodeHash:(NSString *)contractCodeHash message:(NSDictionary<NSString *, SecretkJsonElement *> *)message completionHandler:(void (^)(id _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("encrypt(contractCodeHash:message:completionHandler:)")));
...
@interface SecretkEnigmaUtils : SecretkBase <SecretkEncryptionUtils>
...
@interface SecretkEnigmaUtilsCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkResultCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (SecretkResult *)component2 __attribute__((swift_name("component2()")));
...
@interface SecretkTxKeyResponseCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkAttributeCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSArray<SecretkAttribute *> *)component2 __attribute__((swift_name("component2()")));
...
@interface SecretkEventCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSArray<SecretkEvent *> *)component3 __attribute__((swift_name("component3()")));
...
@interface SecretkLogCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (SecretkStdFee *)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (NSArray<SecretkTypeValue<T> *> *)component5 __attribute__((swift_name("component5()")));
- (NSString *)component6 __attribute__((swift_name("component6()")));
...
@interface SecretkSignJsonCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (SecretkBignumBigInteger *)component1 __attribute__((swift_name("component1()")));
- (SecretkBignumBigInteger *)component2 __attribute__((swift_name("component2()")));
...
__attribute__((swift_name("OfflineSigner")))
@protocol SecretkOfflineSigner
@required
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PrehashType")))
@interface SecretkPrehashType : SecretkKotlinEnum<SecretkPrehashType *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SecretkPrehashType *sha256 __attribute__((swift_name("sha256")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Secp256k1Pen")))
@interface SecretkSecp256k1Pen : SecretkBase
@property (class, readonly, getter=companion) SecretkSecp256k1PenCompanion *companion __attribute__((swift_name("companion")));
- (SecretkStdSignature *)signSignBytes:(id)signBytes prehashType:(SecretkPrehashType *)prehashType __attribute__((swift_name("sign(signBytes:prehashType:)")));
- (SecretkStdSignature *)signDirectSenderAddress:(NSString *)senderAddress signDoc:(SecretkSignDocProto *)signDoc __attribute__((swift_name("signDirect(senderAddress:signDoc:)")));
@property (readonly) id pubkey __attribute__((swift_name("pubkey")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Secp256k1Pen.Companion")))
@interface SecretkSecp256k1PenCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkSecp256k1PenCompanion *shared __attribute__((swift_name("shared")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)fromMnemonicMnemonic:(NSString *)mnemonic hdPath:(SecretkKotlinArray<id> *)hdPath completionHandler:(void (^)(SecretkSecp256k1Pen * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fromMnemonic(mnemonic:hdPath:completionHandler:)")));
@end;
...
- (int32_t)component1 __attribute__((swift_name("component1()")));
- (NSArray<SecretkBasePoint<C> *> *)component2 __attribute__((swift_name("component2()")));
...
- (SecretkBasePoint<C> * _Nullable)component1 __attribute__((swift_name("component1()")));
- (SecretkComputedDoubles<C> * _Nullable)component2 __attribute__((swift_name("component2()")));
- (SecretkComputedNaf<C> *)component3 __attribute__((swift_name("component3()")));
...
- (SecretkBN *)component1 __attribute__((swift_name("component1()")));
- (SecretkBN *)component2 __attribute__((swift_name("component2()")));
- (SecretkBN *)component3 __attribute__((swift_name("component3()")));
...
- (SecretkBN *)component1 __attribute__((swift_name("component1()")));
- (SecretkBN *)component2 __attribute__((swift_name("component2()")));
- (NSArray<SecretkBasis *> *)component3 __attribute__((swift_name("component3()")));
...
- (SecretkBoolean * _Nullable)component1 __attribute__((swift_name("component1()")));
- (SecretkBN * _Nullable)component2 __attribute__((swift_name("component2()")));
...
- (int32_t)component1 __attribute__((swift_name("component1()")));
- (NSArray<NSArray<NSString *> *> *)component2 __attribute__((swift_name("component2()")));
...
- (SecretkDoubles *)component1 __attribute__((swift_name("component1()")));
- (SecretkNaf *)component2 __attribute__((swift_name("component2()")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getAccountAddress:(NSString *)address completionHandler:(void (^)(SecretkAccount_ * _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getAccount(address:completionHandler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)postTxTx:(id)tx completionHandler:(void (^)(SecretkPostTxResult * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("postTx(tx:completionHandler:)")));
...
@interface SecretkSigningCosmWasmClientCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)doInitApiUrl:(NSString *)apiUrl senderAddress:(NSString *)senderAddress pen:(SecretkSecp256k1Pen *)pen enigmaUtils:(id<SecretkEncryptionUtils>)enigmaUtils customFees:(SecretkFeeTable * _Nullable)customFees broadcastMode:(SecretkBroadcastMode *)broadcastMode completionHandler:(void (^)(SecretkSigningCosmWasmClient * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("doInit(apiUrl:senderAddress:pen:enigmaUtils:customFees:broadcastMode:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)doInitApiUrl:(NSString *)apiUrl senderAddress:(NSString *)senderAddress signer:(SecretkSecp256k1Pen *)signer seed:(id _Nullable)seed customFees:(SecretkFeeTable * _Nullable)customFees broadcastMode:(SecretkBroadcastMode *)broadcastMode completionHandler:(void (^)(SecretkSigningCosmWasmClient * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("doInit(apiUrl:senderAddress:signer:seed:customFees:broadcastMode:completionHandler:)")));
@end;
...
@interface SecretkMsgInstantiateContract : SecretkBase <SecretkMsg>
- (instancetype)initWithSender:(NSString *)sender codeHash:(NSString * _Nullable)codeHash __attribute__((swift_name("init(sender:codeHash:)"))) __attribute__((objc_designated_initializer));
...
@interface SecretkProtoMsgCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithTypeUrl:(NSString *)typeUrl value:(SecretkKotlinByteArray *)value __attribute__((swift_name("init(typeUrl:value:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkAnyProtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *typeUrl __attribute__((swift_name("typeUrl")));
...
@interface SecretkAnyProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithSignerInfos:(NSArray<SecretkSignerInfoProto *> *)signerInfos fee:(SecretkFeeProto * _Nullable)fee __attribute__((swift_name("init(signerInfos:fee:)"))) __attribute__((objc_designated_initializer));
...
@interface SecretkAuthInfoProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkCoinProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithAmount:(NSArray<SecretkCoinProto *> *)amount gasLimit:(SecretkInt * _Nullable)gasLimit payer:(NSString * _Nullable)payer granter:(NSString * _Nullable)granter __attribute__((swift_name("init(amount:gasLimit:payer:granter:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkFeeProtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSArray<SecretkCoinProto *> *amount __attribute__((swift_name("amount")));
...
@interface SecretkFeeProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkKeyProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithSingle:(SecretkModeInfoProtoSingle * _Nullable)single multi:(SecretkModeInfoProtoMulti * _Nullable)multi __attribute__((swift_name("init(single:multi:)"))) __attribute__((objc_designated_initializer));
...
@interface SecretkModeInfoProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkModeInfoProtoMultiCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkModeInfoProtoSingleCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithMsgType:(NSString *)msgType data:(SecretkKotlinByteArray *)data __attribute__((swift_name("init(msgType:data:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkMsgDataProtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) SecretkKotlinByteArray *data __attribute__((swift_name("data")));
...
@interface SecretkMsgDataProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithSender:(SecretkKotlinByteArray *)sender contract:(SecretkKotlinByteArray *)contract msg:(SecretkKotlinByteArray *)msg callbackCodeHash:(NSString * _Nullable)callbackCodeHash sentFunds:(NSArray<SecretkCoinProto *> *)sentFunds __attribute__((swift_name("init(sender:contract:msg:callbackCodeHash:sentFunds:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkMsgExecuteContractProtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString * _Nullable callbackCodeHash __attribute__((swift_name("callbackCodeHash")));
@property (readonly) SecretkKotlinByteArray *contract __attribute__((swift_name("contract")));
...
@interface SecretkMsgExecuteContractProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithSender:(SecretkKotlinByteArray *)sender callbackCodeHash:(NSString *)callbackCodeHash codeId:(NSString *)codeId label:(NSString *)label initMsg:(SecretkKotlinByteArray *)initMsg sentFunds:(NSArray<SecretkCoinProto *> *)sentFunds callbackSig:(SecretkKotlinByteArray *)callbackSig __attribute__((swift_name("init(sender:callbackCodeHash:codeId:label:initMsg:sentFunds:callbackSig:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkMsgInstantiateContractProtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *callbackCodeHash __attribute__((swift_name("callbackCodeHash")));
@property (readonly) SecretkKotlinByteArray *callbackSig __attribute__((swift_name("callbackSig")));
...
@interface SecretkMsgInstantiateContractProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithBodyBytes:(SecretkKotlinByteArray *)bodyBytes authInfoBytes:(SecretkKotlinByteArray *)authInfoBytes chainId:(NSString *)chainId accountNumber:(SecretkInt * _Nullable)accountNumber __attribute__((swift_name("init(bodyBytes:authInfoBytes:chainId:accountNumber:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkSignDocProtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) SecretkInt * _Nullable accountNumber __attribute__((swift_name("accountNumber")));
...
@interface SecretkSignDocProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkSignMode : SecretkKotlinEnum<SecretkSignMode *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SecretkSignMode *signModeUnspecified __attribute__((swift_name("signModeUnspecified")));
@property (class, readonly) SecretkSignMode *signModeDirect __attribute__((swift_name("signModeDirect")));
@property (class, readonly) SecretkSignMode *signModeTextual __attribute__((swift_name("signModeTextual")));
@property (class, readonly) SecretkSignMode *signModeLegacyAminoJson __attribute__((swift_name("signModeLegacyAminoJson")));
...
- (instancetype)initWithPublicKey:(SecretkAnyProto * _Nullable)publicKey modeInfo:(SecretkModeInfoProto * _Nullable)modeInfo sequence:(SecretkInt * _Nullable)sequence __attribute__((swift_name("init(publicKey:modeInfo:sequence:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkSignerInfoProtoCompanion *companion __attribute__((swift_name("companion")));
...
@interface SecretkSignerInfoProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithMessages:(NSArray<SecretkAnyProto *> *)messages memo:(NSString *)memo timeoutHeight:(NSString *)timeoutHeight extensionOptions:(NSArray<SecretkAnyProto *> *)extensionOptions nonCriticalExtensionOptions:(NSArray<SecretkAnyProto *> *)nonCriticalExtensionOptions __attribute__((swift_name("init(messages:memo:timeoutHeight:extensionOptions:nonCriticalExtensionOptions:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkTxBodyProtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSArray<SecretkAnyProto *> *extensionOptions __attribute__((swift_name("extensionOptions")));
@property (readonly) NSString *memo __attribute__((swift_name("memo")));
...
@interface SecretkTxBodyProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkTxMsgDataProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithBodyBytes:(SecretkKotlinByteArray *)bodyBytes authInfoBytes:(SecretkKotlinByteArray *)authInfoBytes signatures:(NSArray<SecretkKotlinByteArray *> *)signatures __attribute__((swift_name("init(bodyBytes:authInfoBytes:signatures:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SecretkTxRawProtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) SecretkKotlinByteArray *authInfoBytes __attribute__((swift_name("authInfoBytes")));
@property (readonly) SecretkKotlinByteArray *bodyBytes __attribute__((swift_name("bodyBytes")));
...
@interface SecretkTxRawProtoCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
@interface SecretkJsonPrimitive (Extensions)
@property (readonly) BOOL boolean __attribute__((swift_name("boolean")));
@property (readonly) SecretkBoolean * _Nullable booleanOrNull __attribute__((swift_name("booleanOrNull")));
...
@property (readonly) SecretkDouble * _Nullable doubleOrNull __attribute__((swift_name("doubleOrNull")));
@property (readonly, getter=float) float float_ __attribute__((swift_name("float_")));
@property (readonly) SecretkFloat * _Nullable floatOrNull __attribute__((swift_name("floatOrNull")));
@property (readonly, getter=int) int32_t int_ __attribute__((swift_name("int_")));
@property (readonly) SecretkInt * _Nullable intOrNull __attribute__((swift_name("intOrNull")));
@property (readonly, getter=long) int64_t long_ __attribute__((swift_name("long_")));
@property (readonly) SecretkLong * _Nullable longOrNull __attribute__((swift_name("longOrNull")));
@end;
...
@property (readonly) SecretkJsonPrimitive *jsonPrimitive __attribute__((swift_name("jsonPrimitive")));
@end;

@interface SecretkJsonArrayBuilder (Extensions)
- (BOOL)addValue:(SecretkBoolean * _Nullable)value __attribute__((swift_name("add(value:)")));
...
- (BOOL)addJsonArrayBuilderAction:(void (^)(SecretkJsonArrayBuilder *))builderAction __attribute__((swift_name("addJsonArray(builderAction:)")));
- (BOOL)addJsonObjectBuilderAction:(void (^)(SecretkJsonObjectBuilder *))builderAction __attribute__((swift_name("addJsonObject(builderAction:)")));
@end;

@interface SecretkJson (Extensions)
- (id _Nullable)decodeFromJsonElementJson:(SecretkJsonElement *)json __attribute__((swift_name("decodeFromJsonElement(json:)")));
- (SecretkJsonElement *)encodeToJsonElementValue:(id _Nullable)value __attribute__((swift_name("encodeToJsonElement(value:)")));
@end;

@interface SecretkJsonObjectBuilder (Extensions)
- (SecretkJsonElement * _Nullable)putKey:(NSString *)key value:(SecretkBoolean * _Nullable)value __attribute__((swift_name("put(key:value:)")));
- (SecretkJsonElement * _Nullable)putKey:(NSString *)key value_:(id _Nullable)value __attribute__((swift_name("put(key:value_:)")));
- (SecretkJsonElement * _Nullable)putKey:(NSString *)key value__:(NSString * _Nullable)value __attribute__((swift_name("put(key:value__:)")));
- (SecretkJsonElement * _Nullable)putJsonArrayKey:(NSString *)key builderAction:(void (^)(SecretkJsonArrayBuilder *))builderAction __attribute__((swift_name("putJsonArray(key:builderAction:)")));
- (SecretkJsonElement * _Nullable)putJsonObjectKey:(NSString *)key builderAction:(void (^)(SecretkJsonObjectBuilder *))builderAction __attribute__((swift_name("putJsonObject(key:builderAction:)")));
@end;
...
@interface SecretkKotlinIntArray : SecretkBase
+ (instancetype)arrayWithSize:(int32_t)size __attribute__((swift_name("init(size:)")));
+ (instancetype)arrayWithSize:(int32_t)size init:(SecretkInt *(^)(SecretkInt *))init __attribute__((swift_name("init(size:init:)")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@property (class, readonly, getter=companion) SecretkOkioByteStringCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)base64 __attribute__((swift_name("base64()")));
- (NSString *)base64Url __attribute__((swift_name("base64Url()")));
- (int32_t)compareToOther:(SecretkOkioByteString *)other __attribute__((swift_name("compareTo(other:)")));
- (void)doCopyIntoOffset:(int32_t)offset target:(SecretkKotlinByteArray *)target targetOffset:(int32_t)targetOffset byteCount:(int32_t)byteCount __attribute__((swift_name("doCopyInto(offset:target:targetOffset:byteCount:)")));
- (BOOL)endsWithSuffix:(SecretkKotlinByteArray *)suffix __attribute__((swift_name("endsWith(suffix:)")));
- (BOOL)endsWithSuffix_:(SecretkOkioByteString *)suffix __attribute__((swift_name("endsWith(suffix_:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (int8_t)getIndex:(int32_t)index __attribute__((swift_name("get(index:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)hex __attribute__((swift_name("hex()")));
- (SecretkOkioByteString *)hmacSha1Key:(SecretkOkioByteString *)key __attribute__((swift_name("hmacSha1(key:)")));
- (SecretkOkioByteString *)hmacSha256Key:(SecretkOkioByteString *)key __attribute__((swift_name("hmacSha256(key:)")));
- (SecretkOkioByteString *)hmacSha512Key:(SecretkOkioByteString *)key __attribute__((swift_name("hmacSha512(key:)")));
- (int32_t)indexOfOther:(SecretkKotlinByteArray *)other fromIndex:(int32_t)fromIndex __attribute__((swift_name("indexOf(other:fromIndex:)")));
- (int32_t)indexOfOther:(SecretkOkioByteString *)other fromIndex_:(int32_t)fromIndex __attribute__((swift_name("indexOf(other:fromIndex_:)")));
- (int32_t)lastIndexOfOther:(SecretkKotlinByteArray *)other fromIndex:(int32_t)fromIndex __attribute__((swift_name("lastIndexOf(other:fromIndex:)")));
- (int32_t)lastIndexOfOther:(SecretkOkioByteString *)other fromIndex_:(int32_t)fromIndex __attribute__((swift_name("lastIndexOf(other:fromIndex_:)")));
- (SecretkOkioByteString *)md5 __attribute__((swift_name("md5()")));
- (BOOL)rangeEqualsOffset:(int32_t)offset other:(SecretkKotlinByteArray *)other otherOffset:(int32_t)otherOffset byteCount:(int32_t)byteCount __attribute__((swift_name("rangeEquals(offset:other:otherOffset:byteCount:)")));
- (BOOL)rangeEqualsOffset:(int32_t)offset other:(SecretkOkioByteString *)other otherOffset:(int32_t)otherOffset byteCount_:(int32_t)byteCount __attribute__((swift_name("rangeEquals(offset:other:otherOffset:byteCount_:)")));
- (SecretkOkioByteString *)sha1 __attribute__((swift_name("sha1()")));
- (SecretkOkioByteString *)sha256 __attribute__((swift_name("sha256()")));
- (SecretkOkioByteString *)sha512 __attribute__((swift_name("sha512()")));
- (BOOL)startsWithPrefix:(SecretkKotlinByteArray *)prefix __attribute__((swift_name("startsWith(prefix:)")));
- (BOOL)startsWithPrefix_:(SecretkOkioByteString *)prefix __attribute__((swift_name("startsWith(prefix_:)")));
- (SecretkOkioByteString *)substringBeginIndex:(int32_t)beginIndex endIndex:(int32_t)endIndex __attribute__((swift_name("substring(beginIndex:endIndex:)")));
- (SecretkOkioByteString *)toAsciiLowercase __attribute__((swift_name("toAsciiLowercase()")));
- (SecretkOkioByteString *)toAsciiUppercase __attribute__((swift_name("toAsciiUppercase()")));
...
- (SecretkShortCurvePoint *)fromJSONCurve:(SecretkShortCurve *)curve obj:(NSArray<SecretkJsonElement *> *)obj red:(BOOL)red __attribute__((swift_name("fromJSON(curve:obj:red:)")));
@end;

__attribute__((swift_name("BignumBigNumber")))
@protocol SecretkBignumBigNumber
@required
- (id<SecretkBignumBigNumber>)abs __attribute__((swift_name("abs()")));
- (id<SecretkBignumBigNumber>)addOther:(id<SecretkBignumBigNumber>)other __attribute__((swift_name("add(other:)")));
- (int32_t)compareToOther_:(id)other __attribute__((swift_name("compareTo(other_:)")));
- (id<SecretkBignumBigNumber>)divideOther:(id<SecretkBignumBigNumber>)other __attribute__((swift_name("divide(other:)")));
- (SecretkKotlinPair<id<SecretkBignumBigNumber>, id<SecretkBignumBigNumber>> *)divideAndRemainderOther:(id<SecretkBignumBigNumber>)other __attribute__((swift_name("divideAndRemainder(other:)")));
- (id<SecretkBignumBigNumberCreator>)getCreator __attribute__((swift_name("getCreator()")));
- (BOOL)isZero __attribute__((swift_name("isZero()")));
- (id<SecretkBignumBigNumber>)multiplyOther:(id<SecretkBignumBigNumber>)other __attribute__((swift_name("multiply(other:)")));
- (id<SecretkBignumBigNumber>)negate __attribute__((swift_name("negate()")));
- (int64_t)numberOfDecimalDigits __attribute__((swift_name("numberOfDecimalDigits()")));
- (id<SecretkBignumBigNumber>)powExponent:(int32_t)exponent __attribute__((swift_name("pow(exponent:)")));
- (id<SecretkBignumBigNumber>)powExponent_:(int64_t)exponent __attribute__((swift_name("pow(exponent_:)")));
- (id<SecretkBignumBigNumber>)remainderOther:(id<SecretkBignumBigNumber>)other __attribute__((swift_name("remainder(other:)")));
- (void)secureOverwrite __attribute__((swift_name("secureOverwrite()")));
- (int32_t)signum __attribute__((swift_name("signum()")));
- (id<SecretkBignumBigNumber>)subtractOther:(id<SecretkBignumBigNumber>)other __attribute__((swift_name("subtract(other:)")));
...
@interface SecretkBignumBigInteger : SecretkBase <SecretkBignumBigNumber, SecretkBignumBitwiseCapable, SecretkKotlinComparable, SecretkBignumByteArraySerializable>
...
@property (class, readonly, getter=companion) SecretkBignumBigIntegerCompanion *companion __attribute__((swift_name("companion")));
- (SecretkBignumBigInteger *)abs __attribute__((swift_name("abs()")));
...
- (int32_t)compareFloatAndBigIntFloat:(float)float_ comparisonBlock:(SecretkInt *(^)(SecretkBignumBigInteger *))comparisonBlock __attribute__((swift_name("compareFloatAndBigInt(float:comparisonBlock:)")));
- (int32_t)compareToOther_:(id)other __attribute__((swift_name("compareTo(other_:)")));
- (int32_t)compareToOther:(id)other __attribute__((swift_name("compareTo(other:)")));
- (SecretkBignumBigInteger *)dec __attribute__((swift_name("dec()")));
- (SecretkBignumBigInteger *)divideOther:(SecretkBignumBigInteger *)other __attribute__((swift_name("divide(other:)")));
- (SecretkKotlinPair<SecretkBignumBigInteger *, SecretkBignumBigInteger *> *)divideAndRemainderOther:(SecretkBignumBigInteger *)other __attribute__((swift_name("divideAndRemainder(other:)")));
- (SecretkBignumBigIntegerQuotientAndRemainder *)divremOther:(SecretkBignumBigInteger *)other __attribute__((swift_name("divrem(other:)")));
...
- (SecretkBignumBigInteger *)gcdOther:(SecretkBignumBigInteger *)other __attribute__((swift_name("gcd(other:)")));
- (id)getBackingArrayCopy __attribute__((swift_name("getBackingArrayCopy()")));
- (id<SecretkBignumBigNumberCreator>)getCreator __attribute__((swift_name("getCreator()")));
- (SecretkBignumBigInteger *)getInstance __attribute__((swift_name("getInstance()")));
- (SecretkBignumSign *)getSign __attribute__((swift_name("getSign()")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (SecretkBignumBigInteger *)inc __attribute__((swift_name("inc()")));
...
- (SecretkBignumBigInteger *)modModulo:(SecretkBignumBigInteger *)modulo __attribute__((swift_name("mod(modulo:)")));
- (SecretkBignumBigInteger *)modInverseModulo:(SecretkBignumBigInteger *)modulo __attribute__((swift_name("modInverse(modulo:)")));
- (SecretkBignumBigInteger *)multiplyOther:(SecretkBignumBigInteger *)other __attribute__((swift_name("multiply(other:)")));
- (SecretkBignumBigInteger *)negate __attribute__((swift_name("negate()")));
- (SecretkBignumBigInteger *)not __attribute__((swift_name("not()")));
- (int64_t)numberOfDecimalDigits __attribute__((swift_name("numberOfDecimalDigits()")));
- (SecretkBignumBigInteger *)orOther:(SecretkBignumBigInteger *)other __attribute__((swift_name("or(other:)")));
- (SecretkBignumBigInteger *)powExponent__:(SecretkBignumBigInteger *)exponent __attribute__((swift_name("pow(exponent__:)")));
- (SecretkBignumBigInteger *)powExponent:(int32_t)exponent __attribute__((swift_name("pow(exponent:)")));
- (SecretkBignumBigInteger *)powExponent_:(int64_t)exponent __attribute__((swift_name("pow(exponent_:)")));
- (SecretkBignumBigIntegerBigIntegerRange *)rangeToOther:(SecretkBignumBigInteger *)other __attribute__((swift_name("rangeTo(other:)")));
- (SecretkBignumBigInteger *)remainderOther:(SecretkBignumBigInteger *)other __attribute__((swift_name("remainder(other:)")));
- (void)secureOverwrite __attribute__((swift_name("secureOverwrite()")));
- (SecretkBignumBigInteger *)setBitAtPosition:(int64_t)position bit:(BOOL)bit __attribute__((swift_name("setBitAt(position:bit:)")));
- (SecretkBignumBigInteger *)shlPlaces:(int32_t)places __attribute__((swift_name("shl(places:)")));
- (int16_t)shortValueExactRequired:(BOOL)exactRequired __attribute__((swift_name("shortValue(exactRequired:)")));
- (SecretkBignumBigInteger *)shrPlaces:(int32_t)places __attribute__((swift_name("shr(places:)")));
- (int32_t)signum __attribute__((swift_name("signum()")));
- (SecretkBignumBigInteger *)sqrt __attribute__((swift_name("sqrt()")));
- (SecretkBignumBigIntegerSqareRootAndRemainder *)sqrtAndRemainder __attribute__((swift_name("sqrtAndRemainder()")));
- (SecretkBignumBigInteger *)subtractOther:(SecretkBignumBigInteger *)other __attribute__((swift_name("subtract(other:)")));
- (NSString *)timesChar:(unichar)char_ __attribute__((swift_name("times(char:)")));
- (SecretkKotlinByteArray *)toByteArray __attribute__((swift_name("toByteArray()")));
- (SecretkBignumModularBigInteger *)toModularBigIntegerModulo:(SecretkBignumBigInteger *)modulo __attribute__((swift_name("toModularBigInteger(modulo:)")));
- (NSString *)description __attribute__((swift_name("description()")));
- (NSString *)toStringBase:(int32_t)base __attribute__((swift_name("toString(base:)")));
- (id)toUByteArray_ __attribute__((swift_name("toUByteArray_()")));
...
- (SecretkBignumBigInteger *)unaryMinus __attribute__((swift_name("unaryMinus()")));
...
@interface SecretkJsonKt : SecretkBase
+ (SecretkJson *)JsonFrom:(SecretkJson *)from builderAction:(void (^)(SecretkJsonBuilder *))builderAction __attribute__((swift_name("Json(from:builderAction:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("JsonElementKt")))
@interface SecretkJsonElementKt : SecretkBase
+ (SecretkJsonPrimitive *)JsonPrimitiveValue:(SecretkBoolean * _Nullable)value __attribute__((swift_name("JsonPrimitive(value:)")));
+ (SecretkJsonPrimitive *)JsonPrimitiveValue_:(id _Nullable)value __attribute__((swift_name("JsonPrimitive(value_:)")));
+ (SecretkJsonPrimitive *)JsonPrimitiveValue__:(NSString * _Nullable)value __attribute__((swift_name("JsonPrimitive(value__:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("JsonElementBuildersKt")))
@interface SecretkJsonElementBuildersKt : SecretkBase
+ (NSArray<SecretkJsonElement *> *)buildJsonArrayBuilderAction:(void (^)(SecretkJsonArrayBuilder *))builderAction __attribute__((swift_name("buildJsonArray(builderAction:)")));
+ (NSDictionary<NSString *, SecretkJsonElement *> *)buildJsonObjectBuilderAction:(void (^)(SecretkJsonObjectBuilder *))builderAction __attribute__((swift_name("buildJsonObject(builderAction:)")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
+ (void)ensureLibsodiumInitializedWithCompletionHandler:(void (^)(SecretkKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("ensureLibsodiumInitialized(completionHandler:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Secp256k1PenKt")))
@interface SecretkSecp256k1PenKt : SecretkBase
...
@required
- (id _Nullable)foldInitial:(id _Nullable)initial operation:(id _Nullable (^)(id _Nullable, id<SecretkKotlinCoroutineContextElement>))operation __attribute__((swift_name("fold(initial:operation:)")));
...
@required
- (id<SecretkKotlinx_coroutines_coreChildHandle>)attachChildChild:(id<SecretkKotlinx_coroutines_coreChildJob>)child __attribute__((swift_name("attachChild(child:)")));
- (void)cancelCause:(SecretkKotlinCancellationException * _Nullable)cause __attribute__((swift_name("cancel(cause:)")));
- (SecretkKotlinCancellationException *)getCancellationException __attribute__((swift_name("getCancellationException()")));
- (id<SecretkKotlinx_coroutines_coreDisposableHandle>)invokeOnCompletionOnCancelling:(BOOL)onCancelling invokeImmediately:(BOOL)invokeImmediately handler:(void (^)(SecretkKotlinThrowable * _Nullable))handler __attribute__((swift_name("invokeOnCompletion(onCancelling:invokeImmediately:handler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)joinWithCompletionHandler:(void (^)(SecretkKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("join(completionHandler:)")));
...
@property (readonly) id<SecretkKotlinSequence> children __attribute__((swift_name("children")));
...
@interface SecretkKotlinByteArray : SecretkBase
+ (instancetype)arrayWithSize:(int32_t)size __attribute__((swift_name("init(size:)")));
+ (instancetype)arrayWithSize:(int32_t)size init:(SecretkByte *(^)(SecretkInt *))init __attribute__((swift_name("init(size:init:)")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (int8_t)getIndex:(int32_t)index __attribute__((swift_name("get(index:)")));
...
@interface SecretkOkioByteStringCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkOkioByteStringCompanion *shared __attribute__((swift_name("shared")));
- (SecretkOkioByteString *)ofData:(SecretkKotlinByteArray *)data __attribute__((swift_name("of(data:)")));
- (SecretkOkioByteString * _Nullable)decodeBase64:(NSString *)receiver __attribute__((swift_name("decodeBase64(_:)")));
...
@required
- (id _Nullable)fromBigIntegerBigInteger:(SecretkBignumBigInteger *)bigInteger __attribute__((swift_name("fromBigInteger(bigInteger:)")));
...
@interface SecretkBignumBigIntegerCompanion : SecretkBase <SecretkBignumBigNumberCreator, SecretkBignumBigNumberUtil, SecretkBignumByteArrayDeserializable>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkBignumBigIntegerCompanion *shared __attribute__((swift_name("shared")));
- (SecretkBignumBigInteger *)createFromWordArrayWordArray:(id)wordArray requestedSign:(SecretkBignumSign *)requestedSign __attribute__((swift_name("createFromWordArray(wordArray:requestedSign:)")));
- (SecretkBignumBigInteger *)fromBigIntegerBigInteger:(SecretkBignumBigInteger *)bigInteger __attribute__((swift_name("fromBigInteger(bigInteger:)")));
- (SecretkBignumBigInteger *)fromByteByte:(int8_t)byte __attribute__((swift_name("fromByte(byte:)")));
- (SecretkBignumBigInteger *)fromByteArraySource:(SecretkKotlinByteArray *)source sign:(SecretkBignumSign *)sign __attribute__((swift_name("fromByteArray(source:sign:)")));
- (SecretkBignumBigInteger *)fromIntInt:(int32_t)int_ __attribute__((swift_name("fromInt(int:)")));
- (SecretkBignumBigInteger *)fromLongLong:(int64_t)long_ __attribute__((swift_name("fromLong(long:)")));
- (SecretkBignumBigInteger *)fromShortShort:(int16_t)short_ __attribute__((swift_name("fromShort(short:)")));
- (SecretkBignumBigInteger *)fromUByteUByte:(uint8_t)uByte __attribute__((swift_name("fromUByte(uByte:)")));
- (SecretkBignumBigInteger *)fromUByteArraySource:(id)source sign:(SecretkBignumSign *)sign __attribute__((swift_name("fromUByteArray(source:sign:)")));
- (SecretkBignumBigInteger *)fromUIntUInt:(uint32_t)uInt __attribute__((swift_name("fromUInt(uInt:)")));
- (SecretkBignumBigInteger *)fromULongULong:(uint64_t)uLong __attribute__((swift_name("fromULong(uLong:)")));
- (SecretkBignumBigInteger *)fromUShortUShort:(uint16_t)uShort __attribute__((swift_name("fromUShort(uShort:)")));
- (SecretkBignumBigInteger *)maxFirst:(SecretkBignumBigInteger *)first second:(SecretkBignumBigInteger *)second __attribute__((swift_name("max(first:second:)")));
- (SecretkBignumBigInteger *)minFirst:(SecretkBignumBigInteger *)first second:(SecretkBignumBigInteger *)second __attribute__((swift_name("min(first:second:)")));
- (SecretkBignumBigInteger *)parseStringString:(NSString *)string base:(int32_t)base __attribute__((swift_name("parseString(string:base:)")));
- (SecretkBignumBigInteger *)tryFromDoubleDouble:(double)double_ exactRequired:(BOOL)exactRequired __attribute__((swift_name("tryFromDouble(double:exactRequired:)")));
- (SecretkBignumBigInteger *)tryFromFloatFloat:(float)float_ exactRequired:(BOOL)exactRequired __attribute__((swift_name("tryFromFloat(float:exactRequired:)")));
@property (readonly) double LOG_10_OF_2 __attribute__((swift_name("LOG_10_OF_2")));
@property (readonly) SecretkBignumBigInteger *ONE __attribute__((swift_name("ONE")));
...
@interface SecretkBignumSign : SecretkKotlinEnum<SecretkBignumSign *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SecretkBignumSign *positive __attribute__((swift_name("positive")));
@property (class, readonly) SecretkBignumSign *negative __attribute__((swift_name("negative")));
@property (class, readonly) SecretkBignumSign *zero __attribute__((swift_name("zero")));
...
@interface SecretkBignumBigIntegerBigIntegerRange : SecretkBase <SecretkKotlinClosedRange, SecretkKotlinIterable>
- (instancetype)initWithStart:(SecretkBignumBigInteger *)start endInclusive:(SecretkBignumBigInteger *)endInclusive __attribute__((swift_name("init(start:endInclusive:)"))) __attribute__((objc_designated_initializer));
- (id<SecretkKotlinIterator>)iterator __attribute__((swift_name("iterator()")));
...
@interface SecretkBignumModularBigInteger : SecretkBase <SecretkBignumBigNumber, SecretkBignumByteArraySerializable>
@property (class, readonly, getter=companion) SecretkBignumModularBigIntegerCompanion *companion __attribute__((swift_name("companion")));
- (SecretkBignumModularBigInteger *)abs __attribute__((swift_name("abs()")));
- (SecretkBignumModularBigInteger *)addOther:(SecretkBignumModularBigInteger *)other __attribute__((swift_name("add(other:)")));
- (int8_t)byteValueExactRequired:(BOOL)exactRequired __attribute__((swift_name("byteValue(exactRequired:)")));
- (int32_t)compareOther:(SecretkBignumModularBigInteger *)other __attribute__((swift_name("compare(other:)")));
- (int32_t)compareToOther_:(id)other __attribute__((swift_name("compareTo(other_:)")));
- (SecretkBignumModularBigInteger *)divideOther:(SecretkBignumModularBigInteger *)other __attribute__((swift_name("divide(other:)")));
- (SecretkKotlinPair<SecretkBignumModularBigInteger *, SecretkBignumModularBigInteger *> *)divideAndRemainderOther:(SecretkBignumModularBigInteger *)other __attribute__((swift_name("divideAndRemainder(other:)")));
- (SecretkBignumModularQuotientAndRemainder *)divremOther:(SecretkBignumModularBigInteger *)other __attribute__((swift_name("divrem(other:)")));
- (double)doubleValueExactRequired:(BOOL)exactRequired __attribute__((swift_name("doubleValue(exactRequired:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (float)floatValueExactRequired:(BOOL)exactRequired __attribute__((swift_name("floatValue(exactRequired:)")));
- (id<SecretkBignumBigNumberCreator>)getCreator __attribute__((swift_name("getCreator()")));
- (SecretkBignumModularBigInteger *)getInstance __attribute__((swift_name("getInstance()")));
- (int32_t)intValueExactRequired:(BOOL)exactRequired __attribute__((swift_name("intValue(exactRequired:)")));
- (SecretkBignumModularBigInteger *)inverse __attribute__((swift_name("inverse()")));
- (BOOL)isZero __attribute__((swift_name("isZero()")));
- (int64_t)longValueExactRequired:(BOOL)exactRequired __attribute__((swift_name("longValue(exactRequired:)")));
- (SecretkBignumModularBigInteger *)multiplyOther:(SecretkBignumModularBigInteger *)other __attribute__((swift_name("multiply(other:)")));
- (SecretkBignumModularBigInteger *)negate __attribute__((swift_name("negate()")));
- (int64_t)numberOfDecimalDigits __attribute__((swift_name("numberOfDecimalDigits()")));
- (SecretkBignumModularBigInteger *)powExponent__:(SecretkBignumBigInteger *)exponent __attribute__((swift_name("pow(exponent__:)")));
- (SecretkBignumModularBigInteger *)powExponent___:(SecretkBignumModularBigInteger *)exponent __attribute__((swift_name("pow(exponent___:)")));
- (SecretkBignumModularBigInteger *)powExponent:(int32_t)exponent __attribute__((swift_name("pow(exponent:)")));
- (SecretkBignumModularBigInteger *)powExponent_:(int64_t)exponent __attribute__((swift_name("pow(exponent_:)")));
- (SecretkBignumModularBigInteger *)remOther:(SecretkBignumModularBigInteger *)other __attribute__((swift_name("rem(other:)")));
- (SecretkBignumModularBigInteger *)remainderOther:(SecretkBignumModularBigInteger *)other __attribute__((swift_name("remainder(other:)")));
- (void)secureOverwrite __attribute__((swift_name("secureOverwrite()")));
- (int16_t)shortValueExactRequired:(BOOL)exactRequired __attribute__((swift_name("shortValue(exactRequired:)")));
- (int32_t)signum __attribute__((swift_name("signum()")));
- (SecretkBignumModularBigInteger *)subtractOther:(SecretkBignumModularBigInteger *)other __attribute__((swift_name("subtract(other:)")));
- (SecretkBignumBigInteger *)toBigInteger __attribute__((swift_name("toBigInteger()")));
- (SecretkKotlinByteArray *)toByteArray __attribute__((swift_name("toByteArray()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (NSString *)toStringBase:(int32_t)base __attribute__((swift_name("toString(base:)")));
...
- (uint32_t)uintValueExactRequired:(BOOL)exactRequired __attribute__((swift_name("uintValue(exactRequired:)")));
- (uint64_t)ulongValueExactRequired:(BOOL)exactRequired __attribute__((swift_name("ulongValue(exactRequired:)")));
- (SecretkBignumModularBigInteger *)unaryMinus __attribute__((swift_name("unaryMinus()")));
- (uint16_t)ushortValueExactRequired:(BOOL)exactRequired __attribute__((swift_name("ushortValue(exactRequired:)")));
...
@interface SecretkKotlinUnit : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)unit __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkKotlinUnit *shared __attribute__((swift_name("shared")));
- (NSString *)description __attribute__((swift_name("description()")));
@end;
...
@interface SecretkBignumModularBigIntegerCompanion : SecretkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SecretkBignumModularBigIntegerCompanion *shared __attribute__((swift_name("shared")));
- (id<SecretkBignumBigNumberCreator>)creatorForModuloModulo:(SecretkBignumBigInteger *)modulo __attribute__((swift_name("creatorForModulo(modulo:)")));
- (id<SecretkBignumBigNumberCreator>)creatorForModuloModulo_:(int8_t)modulo __attribute__((swift_name("creatorForModulo(modulo_:)")));
- (id<SecretkBignumBigNumberCreator>)creatorForModuloModulo__:(int32_t)modulo __attribute__((swift_name("creatorForModulo(modulo__:)")));
- (id<SecretkBignumBigNumberCreator>)creatorForModuloModulo___:(int64_t)modulo __attribute__((swift_name("creatorForModulo(modulo___:)")));
- (id<SecretkBignumBigNumberCreator>)creatorForModuloModulo____:(int16_t)modulo __attribute__((swift_name("creatorForModulo(modulo____:)")));
- (id<SecretkBignumBigNumberCreator>)creatorForModuloModulo_____:(uint8_t)modulo __attribute__((swift_name("creatorForModulo(modulo_____:)")));
...
- (SecretkBignumModularBigInteger *)component1 __attribute__((swift_name("component1()")));
- (SecretkBignumModularBigInteger *)component2 __attribute__((swift_name("component2()")));
...
@required
- (void)disposeOnSelectHandle:(id<SecretkKotlinx_coroutines_coreDisposableHandle>)handle __attribute__((swift_name("disposeOnSelect(handle:)")));
- (id _Nullable)performAtomicTrySelectDesc:(SecretkKotlinx_coroutines_coreAtomicDesc *)desc __attribute__((swift_name("performAtomicTrySelect(desc:)")));
- (void)resumeSelectWithExceptionException:(SecretkKotlinThrowable *)exception __attribute__((swift_name("resumeSelectWithException(exception:)")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (BOOL)isEarlierThanThat:(SecretkKotlinx_coroutines_coreOpDescriptor *)that __attribute__((swift_name("isEarlierThan(that:)")));
...
@interface SecretkKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp : SecretkKotlinx_coroutines_coreOpDescriptor
- (instancetype)initWithAffected:(SecretkKotlinx_coroutines_coreLockFreeLinkedListNode *)affected next:(SecretkKotlinx_coroutines_coreLockFreeLinkedListNode *)next desc:(SecretkKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc *)desc __attribute__((swift_name("init(affected:next:desc:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (void)finishPrepare __attribute__((swift_name("finishPrepare()")));
- (id _Nullable)performAffected:(id _Nullable)affected __attribute__((swift_name("perform(affected:)")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SecretkKotlinx_coroutines_coreLockFreeLinkedListNode *affected __attribute__((swift_name("affected")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)addLastNode:(SecretkKotlinx_coroutines_coreLockFreeLinkedListNode *)node __attribute__((swift_name("addLast(node:)")));
- (BOOL)addLastIfNode:(SecretkKotlinx_coroutines_coreLockFreeLinkedListNode *)node condition:(SecretkBoolean *(^)(void))condition __attribute__((swift_name("addLastIf(node:condition:)")));
- (BOOL)addLastIfPrevNode:(SecretkKotlinx_coroutines_coreLockFreeLinkedListNode *)node predicate:(SecretkBoolean *(^)(SecretkKotlinx_coroutines_coreLockFreeLinkedListNode *))predicate __attribute__((swift_name("addLastIfPrev(node:predicate:)")));
- (BOOL)addLastIfPrevAndIfNode:(SecretkKotlinx_coroutines_coreLockFreeLinkedListNode *)node predicate:(SecretkBoolean *(^)(SecretkKotlinx_coroutines_coreLockFreeLinkedListNode *))predicate condition:(SecretkBoolean *(^)(void))condition __attribute__((swift_name("addLastIfPrevAndIf(node:predicate:condition:)")));
- (BOOL)addOneIfEmptyNode:(SecretkKotlinx_coroutines_coreLockFreeLinkedListNode *)node __attribute__((swift_name("addOneIfEmpty(node:)")));
...
- (SecretkKotlinx_coroutines_coreLockFreeLinkedListNode * _Nullable)removeFirstOrNull __attribute__((swift_name("removeFirstOrNull()")));
- (NSString *)description __attribute__((swift_name("description()")));
