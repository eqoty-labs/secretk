...
actual class SIV {
    ...
    actual fun encrypt(txEncryptionKey: UByteArray, plaintext: UByteArray, associatedData: UByteArray): UByteArray {
    ...
    actual fun decrypt(txEncryptionKey: UByteArray, ciphertext: UByteArray, associatedData: UByteArray): UByteArray {
        val macKey = ByteArray(txEncryptionKey.size/2){ i -> txEncryptionKey[i].toByte() }
        val ctrKey = ByteArray(txEncryptionKey.size/2){ i -> txEncryptionKey[txEncryptionKey.size / 2 + i].toByte() }
